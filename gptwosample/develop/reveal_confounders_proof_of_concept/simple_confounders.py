...
def run_demo(cond1_file, cond2_file, components = 4, root='.', data='data'):
    ...
    if not os.path.exists(os.path.join(data,"toy_data.pickle")):
        read_files_and_pickle(cond1_file, cond2_file, root, D=2000)
